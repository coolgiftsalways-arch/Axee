...
/* =========================================================*
 *   IMPORTANT*
 *   USE SAME PRODUCT DATA AS PRODUCT DETAILS*
 *========================================================= */
...
/* =========================================================*
 *   BUILD SECTIONS FROM REAL products.js*
 *   This fixes:*
 *   /product/void-tee       ❌*
 *   /product/motion-track   ❌*
 *   Now:*
 *   /product/tshirt-1       ✅*
 *   /product/track-1        ✅*
 *   /product/track-2        ✅*
...
function ProductCard({
  ...
  const buyNow = () => {
    ...
    // Product-card BUY NOW should first open the product detail page.
    // Size, quantity and checkout are handled from ProductDetails.jsx.
